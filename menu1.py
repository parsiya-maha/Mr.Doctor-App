...
def return_not_login_error(master:customtkinter.CTkFrame):
    l_path = os.path.join(os.getcwd(),"App\\images\\lock_l.png")
    d_path = os.path.join(os.getcwd(),"App\\images\\lock_d.png")
...
def return_model_layer_menu(master:CustomDropdownMenu):
    ...
    path = os.path.join(os.getcwd(),"App\\images\\model layer.png")
...
def return_contact_us(master:CustomDropdownMenu):
    ...
    if not internet_on() :
        l_path = os.path.join(os.getcwd(),"App\\images\\no-net-l.png")
        d_path = os.path.join(os.getcwd(),"App\\images\\no-net-d.png")
